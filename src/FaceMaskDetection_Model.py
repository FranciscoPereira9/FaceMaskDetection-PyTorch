...
# Training Data
dataset_train = DatasetClass.Dataset(ann_directory,img_directory, transform, mode = 'train')
...
utils.draw_bounding_boxes(img, target['boxes'])
...
# Non max supression to reduce the number of bounding boxes predicted
nms_prediction = utils.apply_nms(prediction, iou_thresh=0.3)
# Draw bounding boxes
utils.draw_bounding_boxes(img, nms_prediction['boxes'])